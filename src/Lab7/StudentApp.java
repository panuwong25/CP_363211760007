...
public class StudentApp {
    ...
    public static void main (String[] args) {
        ...
        ArrayList<Student> myStd = new ArrayList<>();
    ...
    private static void displayData(ArrayList<Student> myStd) {
        System.out.println("data odject below:");
    ...
    private static ArrayList<Student> inputData(ArrayList<Student> myStd, int num_std) {
        ...
        for (int i = 0; i <num_std ; i++) {
            ...
            String levle = sc.nextLine();
            System.out.println("Enter student age: ");
            String age = sc.nextLine();

           myStd.add (new Student(name, id, levle,Integer.parseInt(age)));
